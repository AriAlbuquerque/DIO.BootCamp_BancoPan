package Semanas.SetimaSemana.Exceptions;
  ...
  *************Depuração/Debugging*************
        ...
        Mostrando a pilha do programa e permitindo que você a atravesse em qualquer direção;
    ...
    *************Pilha de Execução de um Programa Java/Stack Trace*************
        ...
        * Stack Trace:
        É a matriz onde encontramos a pilha de excecução da exceção.
        Em outras palavras, podemos dizer que o rastreamento da pilha busca (rastreio) para a próxima linha onde a exceção pode surgir.
